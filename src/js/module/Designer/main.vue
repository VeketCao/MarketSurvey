        ...
        <section class="section">
            ...
            <div class="right-cfg">
                <div class="tab-header">
                    <div class="cfg-tab" :class="{active:tabName==='item'}" @click="tabClick('item')">试题属性配置</div>
                    <div class="cfg-tab" :class="{active:tabName==='page'}" @click="tabClick('page')">问卷属性配置</div>
                </div>
                <div class="tab-content">
                    <item-opts :show="tabName==='item'" :data="curSelect" :items="pageConfig.items"></item-opts>
