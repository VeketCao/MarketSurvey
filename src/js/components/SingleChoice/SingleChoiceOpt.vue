<template>
    <div class="single-choice-item-opt">
        ...
        <div class="list-set">
            ...
            <Row type="flex" class="cell" v-for="(it,index) in data.opts.list" :key="index">
                ...
                <Col span="2"><Checkbox v-model="it.isDefault" @on-change="defaultHandle(it.isDefault,index)"></Checkbox></Col>
                <Col span="1">
    ...
    export default {
        ...
        methods:{
            ...
            defaultHandle(isDefault,index){//勾选默认值操作
                if(isDefault){
                    this.data.opts.list.forEach((it,i) => {
                        if(index == i) {
                            this.data.opts.answer = it.index
                        } else {
                            it.isDefault = false
                        }
                    })
            ...
            moveHandle(index){
                ...
                /*this.$nextTick(() => {
                    this.opts.list.forEach((it) => {
                        if(it.isDefault) {
                            this.opts.answer = it.index
                        }
                    })
                })*/
            },
